...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-52ab550d7d9d8966"></script>
<script type="text/javascript">
  addthis.layers({
    'theme' : 'transparent',
    'share' : {
      'position' : 'left',
      'services' : 'facebook,twitter,mailto'
    }, 
    'follow' : {
      'services' : [
        {'service': 'facebook', 'id': 'KMCWA'}
      ]
    },
    'thankyou' : false
  });
